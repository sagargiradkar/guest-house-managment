...
export function About() {
  ...
  const values = [
    {
      icon: Heart,
      title: 'Guest-Centric',
      description: 'We put our guests at the heart of everything we do, ensuring comfort and satisfaction.'
    },
    {
      icon: Shield,
      title: 'Trust & Safety',
      description: 'All properties are verified and meet our strict quality and safety standards.'
    },
    {
      icon: Award,
      title: 'Excellence',
    ...
    },
    {
      icon: TrendingUp,
      title: 'Innovation',
      description: 'Continuously improving our platform and services with cutting-edge technology.'
    }
  ];
  ...
  // Timeline/Milestones
  const milestones = [
    { year: '2016', title: 'Company Founded', description: 'Started with 5 properties in Pune' },
    { year: '2018', title: 'Expansion', description: 'Extended services to Mumbai and Bangalore' },
    { year: '2020', title: 'Digital Transformation', description: 'Launched our online booking platform' },
    { year: '2023', title: 'Industry Recognition', description: 'Awarded Best Corporate Housing Provider' },
    { year: '2025', title: 'Pan-India Presence', description: '150+ properties across 12 major cities' }
  ];
    ...
    <div className="min-h-screen -mt-12">
      ...
      <section className="relative h-[500px] bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div className={`max-w-3xl text-white transition-all duration-700 ${contentLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              About <span className="text-red-500">Corporate Housing</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed">
              Redefining corporate accommodation with trust, comfort, and excellence since 2016.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className={`transition-all duration-700 ${contentLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>
              <h2 className="text-4xl font-bold mb-6 text-gray-900">Our Story</h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Founded in 2016, Corporate Housing began with a simple vision: to provide safe, 
                  comfortable, and affordable accommodations for corporate professionals, expatriates, 
                  and business travelers across India.
                </p>
                <p>
                  What started as a small operation with just 5 properties in Pune has grown into 
                  one of India's most trusted corporate housing providers, serving over 5,000 satisfied 
                  guests across 12 major cities.
                </p>
                <p>
                  Our success is built on three pillars: quality properties, exceptional service, 
                  and innovative technology. We carefully select and verify each property to ensure 
                  it meets our stringent standards for safety, comfort, and convenience.
                </p>
                <p>
                  Today, we continue to expand our portfolio while maintaining the personal touch 
                  and attention to detail that our guests have come to expect and appreciate.
                </p>
              </div>
            </div>
            <div className={`transition-all duration-700 ${contentLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4'}`}>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className={`hover:shadow-xl transition-all duration-700 ${contentLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  To provide exceptional corporate housing solutions that combine comfort, convenience, 
                  and value, making every guest feel at home no matter where business takes them. 
                  We aim to set new standards in corporate accommodation through quality properties, 
                  transparent pricing, and outstanding customer service.
                </p>
              </CardContent>
            </Card>

            <Card className={`hover:shadow-xl transition-all duration-700 ${contentLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '100ms' }}>
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 rounded-full bg-red-100 flex items-center justify-center text-red-600 mr-4">
                ...
                <p className="text-gray-600 leading-relaxed">
                  To become India's most trusted and preferred corporate housing platform, 
                  recognized for innovation, reliability, and guest satisfaction. We envision 
                  a future where finding quality corporate accommodation is seamless, transparent, 
                  and accessible to everyone, supported by cutting-edge technology and personalized service.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className={`text-center mb-12 transition-all duration-700 ${contentLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Meet Our Leadership Team</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            {[
              {
                ...
                description: 'Every property undergoes rigorous quality checks and verification',
                icon: CheckCircle2
              },
              {
              ...
              },
              {
                ...
                description: 'Properties strategically located near business hubs',
                icon: Globe
              },
              {
                title: 'Flexible Bookings',
                description: 'Short-term and long-term stays with easy cancellation',
                icon: Award
              },
              {
                title: '24/7 Support',
              ...
              },
              {
                ...
                description: 'Fully furnished with WiFi, housekeeping, and more',
                icon: Building2
              }
            ].map((item, index) => (
              <Card
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-red-700">
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied guests who trust us for their corporate housing needs
          </p>
