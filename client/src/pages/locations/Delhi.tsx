  ...
  return (
    <div className="min-h-screen -mt-28">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className={`text-xl text-gray-600 leading-relaxed transition-all duration-700 ${contentLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '100ms' }}>
              Delhi NCR, India's national capital region, is the political and business heart of the country. With world-class infrastructure, excellent connectivity, and a rich cultural heritage, it's the perfect base for business professionals. Our corporate housing solutions offer premium accommodations across Delhi, Gurgaon, and Noida, ensuring comfort and convenience.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Delhi NCR at a Glance</h2>
            <p className="text-xl text-gray-600">Why Delhi is India's power center</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Popular Localities in Delhi NCR</h2>
            <p className="text-xl text-gray-600">Explore the capital region's best areas</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {localities.map((locality, index) => (
              <Card
                ...
                style={{ transitionDelay: `${index * 100}ms` }}
                onClick={() => navigate(`/search?location=delhi&area=${locality.name.toLowerCase()}`)}
              >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Featured Properties in Delhi NCR</h2>
            <p className="text-xl text-gray-600">Premium accommodations across the capital region</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Connected to all parts of India and the world</p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Experience the best of Delhi NCR</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-red-700">
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">Ready to Experience Delhi NCR?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Find your perfect corporate housing in India's national capital region
          </p>
      ...
      <section className="py-8 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-8">
            ...
            <a href="mailto:delhi@corporatehousing.co.in" className="flex items-center gap-2 hover:text-red-500 transition-colors">
              <Mail className="h-5 w-5 text-red-500" />
              <span className="font-semibold">delhi@corporatehousing.co.in</span>
            </a>
          </div>
        </div>
      </section>
