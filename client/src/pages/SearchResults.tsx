...
import { Filter, X, SlidersHorizontal, Search, Star, MapPin } from 'lucide-react';
...
export function SearchResults() {
  ...
  const handleRoomTypeToggle = (roomType: string) => {
    setSelectedRoomTypes((prev) =>
      prev.includes(roomType) ? prev.filter((t) => t !== roomType) : [...prev, roomType]
    );
  };
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 pb-6 border-b">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm">
            <span className="font-medium text-gray-900">₹{priceRange[1]}</span>
          </div>
        </div>
      </div>
          ...
          {[
            ...
            >
              <div className="flex items-center gap-2">
                <Star
                  className={`h-4 w-4 ${
                    minRating === option.value ? 'fill-red-600 text-red-600' : 'text-gray-400'
                  }`}
                />
      ...
      <div className="space-y-4">
        <Label className="text-base font-semibold">Popular Amenities</Label>
  ...
  return (
    <div className="min-h-screen bg-gray-50 -mt-28 pt-28">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Results Header */}
        <div className={`mb-8 transition-all duration-700 ${contentLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 flex items-center gap-2">
                <span className="font-semibold text-gray-900">{sortedHotels.length}</span> properties found
                {activeFiltersCount > 0 && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            {sortedHotels.length > 0 && (
              <div className={`mt-8 text-center transition-all duration-700 ${contentLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '400ms' }}>
                <p className="text-gray-600">
                  Showing <span className="font-semibold text-gray-900">{sortedHotels.length}</span> of{' '}
